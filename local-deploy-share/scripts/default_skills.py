# ── 冷启动预置 Skill 常量 ──
# 在新建用户时自动导入到默认 Agent，让用户开箱即用。
# 每个 Skill 的 content 是完整的 SKILL.md 全文（YAML frontmatter + Markdown body）。
# 内容与 tdai-memory-openclaw-plugin/MemoryPanel/src/panel/http/routes/meta/default-skills.ts 保持一致

DEFAULT_SKILL_CODE_REVIEW_CONTENT = r"""---
name: code-review
...
DEFAULT_SKILL_UNIT_TEST_CONTENT = r"""---
name: unit-test
...
DEFAULT_SKILL_API_DOCS_CONTENT = r"""---
name: api-docs
